...
COMMANDS_BY_ACTION_TYPE: dict[str, tuple[str | None, ...]] = {
    ...
    "file_write": (None,),
    "file_read": (None, "list", "search"),
    "file_manage": ("mkdir", "move", "delete"),
    "system_info": ("info", "processes", "applications", "active_app"),
    "key_press": (None,),
    "open_url": (None,),
...
ACTION_TYPE_DESCRIPTIONS: dict[str, str] = {
    ...
    "file_read": "Read, list, or search files under an allowed local path.",
    "file_manage": "Create a directory, move/rename, or delete a local file or directory.",
    "system_info": "Read-only system/process/application inspection.",
    "key_press": "Press a single named keyboard key one or more times.",
    ...
    "mouse_move": "Move the cursor to screen coordinates without clicking, or read its current position.",
...
ACTION_TYPE_ARGS: dict[str, str] = {
    ...
    "file_read": "{encoding?, max_bytes?}; list:{limit?, include_hidden?}; search:{query, limit?, max_depth?}",
    "file_manage": "mkdir:{}; move:{destination}; delete:{recursive?}",
    "system_info": "processes:{limit?}; applications:{limit?}; active_app:{}",
    "key_press": "{key, presses?, interval?}",
    ...
    "mouse_move": "{x, y, duration_seconds?}; position:{}",
...
ACTION_V2_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    "mouse.position": {
        "name": "mouse.position",
        "namespace": "mouse",
        "description": "Read the cursor's current screen coordinates.",
        "args": "{}",
        "requires_confirm": False,
        "v1": "mouse_move/position",
    },
    "keyboard.press": {
        "name": "keyboard.press",
        "namespace": "keyboard",
        "description": "Press a single named keyboard key one or more times (e.g. space, enter, tab).",
    ...
    "file.search": {
        "name": "file.search",
        "namespace": "file",
        "description": "Search filenames under an allowed local path.",
        "args": "{query, limit?, max_depth?}",
        "requires_confirm": False,
        "v1": "file_read/search",
    },
    "file.mkdir": {
        "name": "file.mkdir",
        "namespace": "file",
        "description": "Create a directory under an allowed local path.",
        "args": "{}",
        "requires_confirm": False,
        "v1": "file_manage/mkdir",
    },
    "file.move": {
        "name": "file.move",
        "namespace": "file",
        "description": "Move or rename a local file or directory under an allowed path.",
        "args": "{destination}",
        "requires_confirm": True,
        "v1": "file_manage/move",
    },
    "file.delete": {
        "name": "file.delete",
        "namespace": "file",
        "description": "Delete a local file or directory under an allowed path.",
        "args": "{recursive?}",
        "requires_confirm": True,
        "v1": "file_manage/delete",
    },
    "system.info": {
        "name": "system.info",
        "namespace": "system",
        "description": "Read-only OS/hardware/disk info for the local machine.",
        "args": "{}",
        "requires_confirm": False,
        "v1": "system_info/info",
    },
    "process.list": {
        "name": "process.list",
        "namespace": "system",
        "description": "List running processes on the local machine.",
        "args": "{limit?}",
        "requires_confirm": False,
        "v1": "system_info/processes",
    },
    "application.list": {
        "name": "application.list",
        "namespace": "system",
        "description": "List installed/available applications on the local machine.",
        "args": "{limit?}",
        "requires_confirm": False,
        "v1": "system_info/applications",
    },
    "app.active": {
        "name": "app.active",
        "namespace": "system",
        "description": "Get the name of the currently focused/foreground application.",
        "args": "{}",
        "requires_confirm": False,
        "v1": "system_info/active_app",
    },
    "screen.size": {
        "name": "screen.size",
        "namespace": "screen",
        "description": "Get the primary screen's resolution in pixels.",
        "args": "{}",
        "requires_confirm": False,
        "v1": "screen.size",
    },
    "screen.pixel": {
        "name": "screen.pixel",
        "namespace": "screen",
        "description": "Read the RGB color of a single screen pixel.",
        "args": "{x, y}",
        "requires_confirm": False,
        "v1": "screen.pixel",
    },
